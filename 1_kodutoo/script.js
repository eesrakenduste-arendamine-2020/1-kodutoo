...
const hourSeier = document.querySelector('[data-hour-seier]')
const minuteSeier = document.querySelector('[data-minute-seier]')
const secondSeier = document.querySelector('[data-second-seier]')
...
function setKell() {
    ...
    setRotation(secondSeier, secondsRatio)
    setRotation(minuteSeier, minutesRatio)
    setRotation(hourSeier, hoursRatio)
}
